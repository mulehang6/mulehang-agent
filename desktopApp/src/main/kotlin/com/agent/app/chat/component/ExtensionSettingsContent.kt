...
internal fun ExtensionSettingsContent(
    ...
    ExtensionAnchorSection(ExtensionAnchor.OVERVIEW) {
        GroupHeader("扩展中心")
    ...
    ExtensionAnchorSection(ExtensionAnchor.PACKAGES) {
    ...
    ExtensionAnchorSection(ExtensionAnchor.SKILLS) {
    ...
    ExtensionAnchorSection(ExtensionAnchor.PROMPTS) {
        GroupHeader("Prompts")
    ...
    ExtensionAnchorSection(ExtensionAnchor.MCP) {
        McpSettingsContent(
            document = document,
    ...
    ExtensionAnchorSection(ExtensionAnchor.HOOKS) {
    ...
    ExtensionAnchorSection(ExtensionAnchor.DIAGNOSTICS) {
        GroupHeader("资源诊断")
