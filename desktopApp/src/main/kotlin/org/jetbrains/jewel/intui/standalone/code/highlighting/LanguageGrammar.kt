...
@Immutable
internal class LanguageGrammar(val name: String, aliases: List<String> = emptyList(), rules: List<TokenRule>) {
    val aliases: List<String> = aliases.toList()
    val rules: List<TokenRule> = rules.toList()
     ...
     */
    fun matches(languageTag: String): Boolean = languageTag in allIdentifiers
