...
internal class SimpleCodeHighlighter(
    val colors: SyntaxHighlightColors,
    val additionalGrammars: List<LanguageGrammar>,
    val highlightDispatcher: CoroutineDispatcher = Dispatchers.Default,
) : CodeHighlighter {
    ...
    private fun tokenize(code: String, grammar: LanguageGrammar): AnnotatedString {
        ...
        return buildAnnotatedString {
            append(code)
            for ((start, end, style) in spans) addStyle(style, start, end)
        }
    }
}
