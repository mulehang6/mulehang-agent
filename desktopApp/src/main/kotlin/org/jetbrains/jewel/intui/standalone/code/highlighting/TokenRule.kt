...
@Immutable
internal class TokenRule(@param:Language("RegExp") val pattern: String, captures: Map<Int, TokenType>) {
    val captures: Map<Int, TokenType> = captures.toMap()
    ...
    companion object {
         ...
         */
        fun functionCall(@Language("RegExp") pattern: String): TokenRule =
         ...
         */
        fun functionDeclaration(@Language("RegExp") pattern: String): TokenRule =
         ...
         */
        fun typeDeclaration(@Language("RegExp") pattern: String): TokenRule =
